...
/**
 * End-to-end tests of WindowedWordCount.
 */
...
public class WindowedWordCountIT {
   ...
   */
  public static interface WindowedWordCountITOptions extends TestPipelineOptions,
         Options, DataflowPipelineOptions {
  }

  @Test
  public void testE2EWindowedWordCount() throws Exception {
    ...
    options.setBigQueryDataset("windowedwordcounts");
